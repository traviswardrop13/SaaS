...
const TONGUE_PATHS: Record<TargetSound, string> = {
  ...
  THV: "M 78 192 Q 105 178 145 178 Q 165 184 175 192 L 90 200 Z",
  ...
  Z: "M 78 195 Q 100 178 130 174 Q 155 174 160 168 Q 162 175 158 184 L 158 198 L 90 198 Z",
  V: "M 78 200 Q 105 196 140 198 Q 158 200 162 202 L 90 204 Z",
  J: "M 78 195 Q 105 180 135 180 Q 155 184 162 192 L 90 200 Z",
...
const HINTS: Partial<Record<TargetSound, string>> = {
  ...
  THV: "Tongue tip between your teeth — and turn your voice on (buzz!).",
  ...
  Z: "Tongue tip up behind your top teeth — buzz with your voice on.",
  V: "Top teeth on your bottom lip — buzz with your voice on.",
  J: "Tongue tip behind top teeth, pop and release — with your voice on.",
