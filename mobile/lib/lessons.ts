...
export const SKILLS: Skill[] = [
  // ───────────────────────── Single sounds ─────────────────────────
  {
    ...
    lessons: [
      ...
      {
        id: "s-sentences",
        title: "S in sentences",
        hint: "Keep the snake hiss going all sentence long!",
        targetSound: "S",
        position: "initial",
        level: "sentences",
        words: [
          { text: "The sun is so hot." },
          { text: "I see six seals." },
          { text: "Sam has soft socks." },
        ],
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      {
        id: "r-sentences",
        title: "R in sentences",
        hint: "Roar through the whole sentence!",
        targetSound: "R",
        position: "initial",
        level: "sentences",
        words: [
          { text: "The red rabbit ran." },
          { text: "Rosa rides a rocket." },
          { text: "Roar like a real lion." },
        ],
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      {
        id: "l-sentences",
        title: "L in sentences",
        hint: "Tongue tip up on every L!",
        targetSound: "L",
        position: "initial",
        level: "sentences",
        words: [
          { text: "Lily likes yellow lemons." },
          { text: "Look at the little lion." },
          { text: "Leo loves lollipops." },
        ],
      },
    ],
  },
