...
const SYSTEM = [
  ...
  "- 'encourage': not quite right — stay positive, gently model the correct word, give ONE tiny mouth cue for the target sound, and invite them to try again. Never say 'wrong' or 'no'.",
...
function userPrompt(b: Body): string {
  ...
  switch (b.action) {
    ...
    case "encourage":
      ...
      } Stay positive, model "${word}" correctly, give ONE tiny mouth cue for ${sound}, and invite another try.`;
    case "moveon":
