...
const sylWant = /^Ready\? Say [a-z]+(, [a-z]+){1,2}, five times\. Go!$/;
console.log((sylWant.test(sylLine) ? "PASS" : "FAIL") + "  E2E r2 spoken set  → " + JSON.stringify(sylLine));
...
ok("syllable set", cases.sylFirst, "Ready? Say rah, ree, roo, five times. Go!");
ok("syllable repeat", cases.sylRepeat, "Ready? Say rah, ree, roo, five times. Go!");
